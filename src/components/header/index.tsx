        ...
        <div className="hidden items-center gap-2 md:flex">
          {user && (
            <>
              ...
              <button
                className="color-trans rounded border p-1 uppercase hover:bg-base-700"
                onClick={signOut}
              >
                sign out
              </button>
          ...
          {!user && (
            <button onClick={signInWithGoogle}>
              <div className="color-trans flex items-center gap-3 rounded border p-4 hover:bg-base-600">
                <svg
                  className="h-6 w-6"
                  viewBox="0 0 256 262"
                  version="1.1"
